...
export class TemaTitulosDirective implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.renderer.setStyle(this.elemento.nativeElement, 'width', 'auto');
    this.renderer.setStyle(this.elemento.nativeElement, 'display', 'inline-block');
    this.renderer.setStyle(this.elemento.nativeElement, 'line-height', '40px');
  }
